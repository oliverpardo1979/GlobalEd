...
\footnotesize
\textit{Note:} Total change, education, and within-group components are percentages of initial synthetic income. The two components add to total change before rounding. ``Same source'' indicates that the Tableau series and survey identifiers are unchanged across endpoints.
\end{minipage}
\end{table}
