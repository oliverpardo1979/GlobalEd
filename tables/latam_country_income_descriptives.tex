...
\footnotesize
\textit{Note:} All observations are fourth-quarter values measured in 2017 PPP US dollars per employed person per month; they are not current US dollars or local currency. Published income is LABLAC's reported total. Synthetic income weights the three education-group means with the published number of workers in each group.
\end{minipage}
\end{table}
