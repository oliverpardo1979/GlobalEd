...
\footnotesize
\textit{Note:} Mean monthly labor income is measured in 2017 PPP US dollars per employed person per month; values are not current US dollars or local currency. All observations correspond to the fourth quarter.
\end{minipage}
\end{table}
